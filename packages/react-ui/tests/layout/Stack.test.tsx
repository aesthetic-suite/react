...
describe('Stack', () => {
	it('renders the element', () => {
		...
		expect(getElement().className).toBe(
			'box variant:alignContent:normal variant:alignItems:stretch variant:alignSelf:auto variant:direction:column variant:justifyContent:flex-start variant:wrap:false element element',
		);
	});
