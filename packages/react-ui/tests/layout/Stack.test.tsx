...
describe('Stack', () => {
	it('renders the element', () => {
		...
		expect(getElement().className).toBe(
			'box variant:align-content:normal variant:align-items:stretch variant:align-self:auto variant:direction:column variant:justify-content:flex-start variant:wrap:false element element',
		);
	});
