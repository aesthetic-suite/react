...
describe('Inline', () => {
	it('renders the element', () => {
		...
		expect(getElement().className).toBe(
			'box variant:alignContent:normal variant:alignItems:center variant:alignSelf:auto variant:direction:row variant:justifyContent:flex-start variant:wrap:false items spacing',
		);
	});
